...
public class CreateColliders : MonoBehaviour
{
    ...
    public ResizeBG BgResizer;

    private void Start()
    {
        Debug.Log("The aspect ratio is " + Camera.main.aspect);
        if (Camera.main.aspect <= 0.5f)
        {
            Camera.main.orthographicSize = 6f;
        }
        //Create a Dictionary to contain all our Objects/Transforms
        Dictionary<string, Transform> colliders = new System.Collections.Generic.Dictionary<string, Transform>();
        ...
        BgResizer.ResizeSpriteToScreen();
    }
}
